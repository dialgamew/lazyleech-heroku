...
@Client.on_message(filters.command(['torrent002', 'ziptorrent002', 'filetorrent002']) & filters.chat(ALL_CHATS))
...
@Client.on_message(filters.command(['magnet002', 'zipmagnet002', 'filemagnet002']) & filters.chat(ALL_CHATS))
...
@Client.on_message(filters.command(['directdl002', 'direct002', 'zipdirectdl002', 'zipdirect002', 'filedirectdl002', 'filedirect002']) & filters.chat(ALL_CHATS))
...
@Client.on_message(filters.command('cancel002') & filters.chat(ALL_CHATS))
