...
EVERYONE_CHATS = list(map(int, EVERYONE_CHATS.split(' '))) if EVERYONE_CHATS else [-1001593677670]
ADMIN_CHATS = os.environ.get('ADMIN_CHATS')
ADMIN_CHATS = list(map(int, ADMIN_CHATS.split(' '))) if ADMIN_CHATS else [1366555127]
...
MAGNET_TIMEOUT = int(os.environ.get('LEECH_TIMEOUT', 31556952))
LEECH_TIMEOUT = int(os.environ.get('LEECH_TIMEOUT', 31556952))
